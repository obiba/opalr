...
o1<-opal.login('dsuser1', 'password', 'https://some.opal.host:8443',opts=list(ssl.verifyhost=0,ssl.verifypeer=0,sslversion=3))
o2<-opal.login('dsuser2', 'password', 'https://some.other.opal.host:8443',opts=list(ssl.verifyhost=0,ssl.verifypeer=0,sslversion=3))
opals<-list(o1, o2)
