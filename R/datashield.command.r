...
datashield.commands.opal <- function(opal) {
  ...
  opal:::.get(opal, "datashield", "session", opal:::.getRSessionId(opal), "commands")
}
...
datashield.command.opal <- function(opal, id, wait=FALSE) {
  ...
  opal:::.get(opal, "datashield", "session", opal:::.getRSessionId(opal), "command", id, query=query)
}
...
datashield.command_rm.opal <- function(opal, id) {
  ...
  tryCatch(opal:::.delete(opal, "datashield", "session", opal:::.getRSessionId(opal), "command", id), error=function(e){})
}
...
datashield.command_result.opal <- function(opal, id, wait=FALSE) {
  ...
  .get(opal, "datashield", "session", opal:::.getRSessionId(opal), "command", id, "result")
}
